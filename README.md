...
ES6 modules, modals, refactoring, clean code.
...
You can view the layout of the project through [THIS LINK](https://www.figma.com/file/4xgsOul3pumPaSJUBfaELq/IMC-(Copy)?node-id=6%3A4). You need an account on [Figma](https://figma.com) to access it.


## 🚀 Deploy

https://ricardodev10.github.io/calcular-imc/
